...
select
  ...
  try_cast(g.NPTBillableHours as decimal(10,2))                       as npt_billable_hours,
  ...
  cast(g.DriverShiftId as string)                                    as upstream_driver_shift_id,
  try_cast(g.MilesTraveled as decimal(10,2))                         as upstream_miles_traveled,
